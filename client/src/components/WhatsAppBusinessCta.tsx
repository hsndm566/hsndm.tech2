...
export function WhatsAppBusinessCta() {
  ...
  return <a className="fixed bottom-4 left-4 z-40 inline-flex items-center gap-2 border border-[#10B981] bg-[#10B981] px-4 py-3 font-mono text-xs text-[#111827] shadow-lg transition-transform duration-150 hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#065F46] active:scale-[.97] sm:left-auto sm:right-4" href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(message)}`} target="_blank" rel="noreferrer" aria-label={text}>
