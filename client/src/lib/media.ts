/**
 * Approved managed MP4s for the hero and See It Work explainer. Each immutable
...
export const EXPLAINER_VIDEO_URL = "/manus-storage/autoapply-onboarding-walkthrough.mp4";
