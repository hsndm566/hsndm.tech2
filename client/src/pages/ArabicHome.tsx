  ...
  return (
    <div className="site-shell" lang="ar" dir="rtl">
      ...
      <main id="top">
        ...
        <SectionErrorBoundary name="arabic-approval-promise" fallback={<section className="proof-strip" aria-label="وعد الموافقة"><div className="page-frame proof-grid"><div><StatusDot /> لا يُقدَّم شيء دون موافقتك</div></div></section>}><section className="proof-strip" aria-label="وعد الموافقة"><div className="page-frame proof-grid"><div><span className="proof-step">01</span><StatusDot /> <span>نبحث ونُعِدّ الطلبات</span></div><div><span className="proof-step">02</span><StatusDot /> <span>تراجع وتوافق</span></div><div><span className="proof-step">03</span><StatusDot /> <span>لا يُقدَّم شيء دون موافقتك</span></div><div><span className="proof-step">04</span><StatusDot /> <span>كل طلب يبقى واضحاً أمامك</span></div></div></section></SectionErrorBoundary>
